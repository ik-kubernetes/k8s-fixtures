...
- [CSI driver sources](https://github.com/kubernetes-sigs/secrets-store-csi-driver)
- [CSI driver aws workshop](https://www.eksworkshop.com/beginner/194_secrets_manager/configure-csi-driver/)
